...
class TestingAgent(BaseAgent):
    ...
    def __init__(self, model: Optional[str] = None, **kwargs):
        super().__init__(
            ...
            goal="Generate comprehensive test suites and run tests to ensure code quality and correctness",
            model=model,
            **kwargs
        )
...
Generate tests that are maintainable, reliable, and provide good coverage of the code under test.
""",
        ])
