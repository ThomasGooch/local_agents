...
class CodingAgent(BaseAgent):
    ...
    def __init__(self, model: Optional[str] = None, **kwargs):
        super().__init__(
            ...
            goal="Generate high-quality, maintainable code that follows best practices and integrates well with existing codebases",
            model=model,
            **kwargs
        )
...
Please provide the complete code implementation with clear explanations of any important design decisions.
""",
        ])
    ...
    def _add_project_context(self, prompt_parts: List[str], directory: Path) -> None:
        ...
        project_files = []
        for file_pattern in ['package.json', 'requirements.txt', 'Cargo.toml', 'go.mod', 'pom.xml', 'build.gradle']:
    ...
    def generate_function(
        ...
        task = f"Generate a {language} function named '{function_name}' that {description}"
