...
class PerformanceMonitor:
    ...
    def get_system_recommendations(self) -> Dict[str, Any]:
        ...
        if memory_gb >= 16 and cpu_cores >= 6:
            return {
                ...
                "cache_enabled": True,
                "optimization_notes": [
                    f"Excellent hardware for Local Agents ({memory_gb}GB RAM, {cpu_cores} cores)",
            ...
            return {
                ...
                "cache_enabled": True,
                "optimization_notes": [
                    f"Good hardware for Local Agents ({memory_gb}GB RAM, {cpu_cores} cores)",
    ...
    def display_performance_report(self) -> None:
        ...
        rec_text = f"**Performance Tier**: {recommendations['tier'].replace('_', ' ').title()}\n\n"
        rec_text += f"**Recommended Models**: {', '.join(recommendations['recommended_models'])}\n\n"
