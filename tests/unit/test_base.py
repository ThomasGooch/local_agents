...
from local_agents.exceptions import ModelNotAvailableError, ConfigurationError
...
class TestBaseAgent:
    ...
    def test_agent_initialization_with_config(self, mock_get_config, mock_ollama_client):
        ...
        with patch('local_agents.config.get_model_for_agent', return_value='config:model'):
            agent = TestAgent(
                agent_type="test",
                role="Test Agent",
                goal="Test goal",
