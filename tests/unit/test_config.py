...
from local_agents.config import Config, ConfigManager, AgentSettings, WorkflowConfig
...
class TestConfigManager:
    ...
    def test_get_workflow_steps(self):
        ...
        assert manager.get_workflow_steps("feature-dev") == ["plan", "code", "test", "review"]
        assert manager.get_workflow_steps("bug-fix") == ["plan", "code", "test"]
        assert manager.get_workflow_steps("code-review") == ["review"]
        assert manager.get_workflow_steps("refactor") == ["plan", "code", "test", "review"]
